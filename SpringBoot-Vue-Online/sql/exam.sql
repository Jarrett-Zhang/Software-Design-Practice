...
) ENGINE = InnoDB AUTO_INCREMENT = 20190014 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '考试管理表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of exam_manage
-- ----------------------------
INSERT INTO `exam_manage` VALUES (20240001, '2024年上期期末考试', '计算机网络', 1001, '2024-03-21', 120, '2021', '1', '计算机科学与技术', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20240002, '2024年上期期末考试', '数据库理论', 1002, '2024-03-07', 90, '2021', '2', '网络工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20240003, '2024年下期期末考试', '数据结构', 1003, '2024-02-27', 90, '2021', '1', '软件工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20240005, '2024年上期期末考试', '计算机导论', 1004, '2024-03-14', 90, '2021', '1', '计算机科学与技术', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20240006, '2024年上期期末考试', '软件工程', 1005, '2024-03-21', 120, '2021', '1', '计算机科学与技术', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20240007, '2024年上期期末考试', '操作系统', 1006, '2024-03-13', 120, '2021', '2', '计算机科学与技术', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20240008, '2024年下期期末考试', 'C语言', 1007, '2024-03-13', 120, '2021', '1', '信息工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20240009, '2024年上期期末考试', '高等数学', 1008, '2024-03-07', 90, '2021', '1', '信息工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20240013, '测试', '测试', 1009, '2024-04-24', 120, '2021', NULL, '测试', '测试', 100, '期末考试', '请不要带与考试无关的书籍。');
...
CREATE TABLE `judge_question`  (
  ...
  `section` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NULL DEFAULT NULL COMMENT '所属章节',
  PRIMARY KEY (`questionId`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10014 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '判断题题库表' ROW_FORMAT = Dynamic;
...
INSERT INTO `judge_question` VALUES (10013, '计算机网络', '1', 'T', '去', 2, '', '');
...
-- Records of message
-- ----------------------------
INSERT INTO `message` VALUES (2, '晚上加班,这感觉非常的nice', '今天是星期一的晚上,下班后回到宿舍继续写我的毕业设计,看着项目功能日渐丰满好开心哦,你们也要元气满满哦！', '2024-06-15');
INSERT INTO `message` VALUES (15, '咸鱼', '我是一条咸鱼', '2024-06-15');
INSERT INTO `message` VALUES (16, '今天中午吃什么', '今天去吃莲藕排骨汤吧，虽然也不好吃，但这里真的没什么东西可以吃了', '2024-06-15');
INSERT INTO `message` VALUES (20, '这个网站不错', '博主大大好厉害，网页看着很清新呢，喜欢这样嘞风格。', '2024-06-15');
INSERT INTO `message` VALUES (21, '男孩子', '哇，这么可爱，那肯定是男孩子呀。', '2024-06-15');
INSERT INTO `message` VALUES (22, '好人', '你是个好人，可是我们不合适。', '2024-06-15');
INSERT INTO `message` VALUES (25, '小乔', '花会枯萎，爱永不凋零，小乔要努力变强。', '2024-06-15');
INSERT INTO `message` VALUES (26, '妲己', '妲己会一直爱主人，因为被设定成这样，来和妲己玩耍吧。', '2024-06-15');
INSERT INTO `message` VALUES (27, '土味情话', '妈妈从小对我讲，不要早恋，遇到你以后，我决定不听妈妈的话了。', '2024-06-15');
INSERT INTO `message` VALUES (35, '贝塔', '开坦克', '2024-06-15');
...
CREATE TABLE `multi_question`  (
  ...
  `level` varchar(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NULL DEFAULT NULL COMMENT '难度等级',
  PRIMARY KEY (`questionId`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10033 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '选择题题库表' ROW_FORMAT = Dynamic;
...
-- Records of replay
-- ----------------------------
INSERT INTO `replay` VALUES (26, 3, '好呀，我来了，你别跑！', '2024-06-15');
INSERT INTO `replay` VALUES (22, 4, '心疼你2秒钟', '2024-06-15');
INSERT INTO `replay` VALUES (25, 5, '我也要变强', '2024-06-15');
INSERT INTO `replay` VALUES (25, 6, '俺也一样', '2024-06-15');
INSERT INTO `replay` VALUES (15, 9, '咸鱼其实还可以吃，而你,emmmm', '2024-06-15');
INSERT INTO `replay` VALUES (33, 18, '是的，今天是周六。', '2024-06-15');
...
) ENGINE = InnoDB AUTO_INCREMENT = 32 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '成绩管理表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of score
-- ----------------------------
INSERT INTO `score` VALUES (4, 20240001, 20214084, '计算机网络', NULL, 70, NULL, '2024-04-03');
INSERT INTO `score` VALUES (14, 20240002, 20214084, '数据库理论', NULL, 78, NULL, '2024-04-20');
INSERT INTO `score` VALUES (15, 20240002, 20214084, '数据库理论', NULL, 80, NULL, '2024-04-20');
INSERT INTO `score` VALUES (16, 20240002, 20214084, '数据库理论', NULL, 83, NULL, '2024-04-20');
INSERT INTO `score` VALUES (17, 20240001, 20214001, '计算机网络', NULL, 74, NULL, '2024-04-13');
INSERT INTO `score` VALUES (18, 20240001, 20214001, '计算机网络', NULL, 70, NULL, '2024-04-10');
INSERT INTO `score` VALUES (19, 20240001, 20215003, '计算机网络', NULL, 86, NULL, '2024-04-14');
INSERT INTO `score` VALUES (20, 20240001, 20215007, '计算机网络', NULL, 90, NULL, '2024-04-11');
INSERT INTO `score` VALUES (21, 20240001, 20215007, '计算机网络', NULL, 92, NULL, '2024-04-12');
INSERT INTO `score` VALUES (22, 20240001, 20215008, '计算机网络', NULL, 80, NULL, '2024-04-12');
INSERT INTO `score` VALUES (23, 20240001, 20215003, '计算机网络', NULL, 90, NULL, '2024-04-13');
INSERT INTO `score` VALUES (24, 20240001, 20215008, '计算机网络', NULL, 88, NULL, '2024-04-14');
INSERT INTO `score` VALUES (27, 20240001, 20214084, '计算机网络', NULL, 80, NULL, '2024-04-25');
INSERT INTO `score` VALUES (30, 20240001, 20214084, '计算机网络', NULL, 0, NULL, '2024-04-29');
INSERT INTO `score` VALUES (31, 20240001, 20241084, '计算机网络', NULL, 0, NULL, '2023-09-06');
...
) ENGINE = InnoDB AUTO_INCREMENT = 20155009 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '学生信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of student
-- ----------------------------
INSERT INTO `student` VALUES (20214001, '1', '2021', '计算机科学与技术', '2', '软件工程学院', '13585439532', 'gblw@163.com', '123456', '3412312', '男', '2');
INSERT INTO `student` VALUES (20214084, '2', '2021', '计算机科学与技术', '2', '软件工程学院', '13658377857', '13658377857@sina.cn', '123456', '124123124535', '男', '2');
INSERT INTO `student` VALUES (20215003, '3', '2021', '信息工程', '1', '软件工程学院', '15583829425', '15583829425@163.com', '123456', '3242342', '男', '2');
INSERT INTO `student` VALUES (20215007, '4', '2021', '网络工程', '1', '软件工程学院', '18734538457', '18734538457@163.com', '123456', '2423423', '女', '2');
INSERT INTO `student` VALUES (20215008, '5', '2021', '信息工程', '2', '软件工程学院', '15523619564', '15523619564@163.com', '123456', '500234199704022353', '男', '2');
...
-- Records of teacher
-- ----------------------------
INSERT INTO `teacher` VALUES (20081001, '11', '软件工程学院', '男', '13598458442', '13598458442@163.com', '123456', '423423283498', '讲师', '1');
INSERT INTO `teacher` VALUES (20081002, '12', '软件工程学院', '男', '1231221312', '1231221312@163.com', '123456', '24241234', '讲师', '1');
