...
<template>
  <div id="login">
          ...
          <div class="container">
            ...
            <el-form :label-position="labelPosition" label-width="80px" :model="formLabelAlign">
              <el-form-item label="用户名">
                <el-input v-model.number="formLabelAlign.username" placeholder="请输入用户名"type='username'></el-input>
              </el-form-item>
    ...
    <el-row class="footer">
      <el-col>
        <p class="msg2">版权所有 ©2024 湘潭大学21级计科一班保留所有权利  <a href="http://beian.miit.gov.cn/" target="_blank">湘ICP备****号</a></p>
      </el-col>
    </el-row>
    <section class="remind">
      <span>管理员账号：9527</span>
      <span>教师账号：20081001</span>
      <span>学生1号：20214001</span>
...
#login .bg {
  ...
  overflow-y: auto;
  height: 100%;
  background: url('../../assets/img/gaikuang.jpg')center top / cover no-repeat;
